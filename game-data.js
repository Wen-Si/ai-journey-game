...
const GameData = {
    ...
    levels: [
        {
            ...
            choices: [
                {
                    text: '帮助帕斯卡改进机械加法器的设计',
                    type: 'good',
                    wisdomBonus: 20,
                    nextScene: 'scene1_help'
                },
                {
                    text: '向帕斯卡介绍现代计算机的概念',
                    type: 'risky',
                    wisdomBonus: 30,
                    nextScene: 'scene1_future'
                },
                {
                    text: '观察并记录帕斯卡的工作方法',
                    type: 'neutral',
                    wisdomBonus: 10,
                    nextScene: 'scene1_observe'
                }
            ]
        },
        {
            ...
            choices: [
                {
                    ...
                    type: 'good',
                    wisdomBonus: 25,
                    nextScene: 'scene2_build'
                },
                {
                    text: '建议巴贝奇直接设计分析机',
                    type: 'risky',
                    wisdomBonus: 35,
                    nextScene: 'scene2_analytical'
                },
                {
                    text: '与巴贝奇讨论编程的概念',
                    type: 'creative',
                    wisdomBonus: 30,
                    nextScene: 'scene2_program'
                }
            ]
        },
        {
            ...
            choices: [
                {
                    ...
                    type: 'good',
                    wisdomBonus: 30,
                    nextScene: 'scene3_bombe'
                },
                {
                    text: '向图灵展示未来的计算机发展',
                    type: 'risky',
                    wisdomBonus: 40,
                    nextScene: 'scene3_future'
                },
                {
                    text: '讨论机器是否能思考的问题',
                    type: 'creative',
                    wisdomBonus: 35,
                    nextScene: 'scene3_thinking'
                }
            ]
        },
        {
            ...
            choices: [
                ...
                },
                {
                    ...
                    type: 'creative',
                    wisdomBonus: 35,
                    nextScene: 'scene4_neural'
                },
                {
                    text: '建议关注机器学习的实际应用',
                    type: 'practical',
                    wisdomBonus: 30,
                    nextScene: 'scene4_practical'
                }
            ]
        },
        {
            ...
            choices: [
                {
                    ...
                    type: 'good',
                    wisdomBonus: 35,
                    nextScene: 'scene6_dbn'
                },
                {
                    text: '建议使用GPU加速神经网络训练',
                    type: 'creative',
                    wisdomBonus: 40,
                    nextScene: 'scene6_gpu'
                },
                {
                    text: '探讨深度学习在图像识别中的应用',
                    type: 'practical',
                    wisdomBonus: 30,
                    nextScene: 'scene6_vision'
                }
            ]
        },
        {
            ...
            choices: [
                {
                    ...
                    type: 'good',
                    wisdomBonus: 35,
                    nextScene: 'scene7_attention'
                },
                {
                    text: '建议将Transformer应用于更多领域',
                    type: 'creative',
                    wisdomBonus: 40,
                    nextScene: 'scene7_extend'
                },
                {
                    text: '思考Transformer对AI发展的意义',
                    type: 'strategic',
                    wisdomBonus: 30,
                    nextScene: 'scene7_meaning'
                }
            ]
        },
        {
            ...
            choices: [
                {
                    ...
                    type: 'good',
                    wisdomBonus: 40,
                    nextScene: 'scene8_rlhf'
                },
                {
                    text: '思考AI安全和对齐问题',
                    type: 'strategic',
                    wisdomBonus: 35,
                    nextScene: 'scene8_safety'
                },
                {
                    text: '探索AI与人类协作的未来',
                    type: 'creative',
                    wisdomBonus: 45,
                    nextScene: 'scene8_future'
                }
            ]
        }
    ],
    ...
    endings: {
        pioneer: {
            title: 'AI先驱者',
            icon: '🚀',
            description: '你以卓越的智慧和远见，成为了AI发展史上的重要推动者。你证明了人类创造力是无可替代的。',
            condition: 'wisdom >= 300'
        },
        scholar: {
            title: '智慧学者',
            icon: '📚',
            description: '你通过不断学习和思考，深刻理解了AI的本质。知识是你最强大的武器。',
            condition: 'knowledge >= 20'
        },
        collaborator: {
            title: '人机协作者',
            icon: '🤝',
            description: '你找到了与AI和谐共存的方式，证明了人类与AI可以携手创造更美好的未来。',
            condition: 'empathy_bonus >= 3'
        },
        survivor: {
            title: '时代幸存者',
            icon: '💪',
            description: '你在AI时代的浪潮中找到了自己的位置，证明了人类的韧性和适应能力。',
            condition: 'default'
        }
    }
};
